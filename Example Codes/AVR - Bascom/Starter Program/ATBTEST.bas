...
Config Lcd = 16x2
Config Lcdpin = Pin , Db4 = Porta.4 , Db5 = Porta.5 , Db6 = Porta.6 , Db7 = Porta.7 , E = Portg.2 , Rs = Porte.4
...
Clock_out Alias Porte.0                                     ' SRCLK - 74HC595
Data_out Alias Porte.1                                      ' SER - of the first 74HC595
Latch_out Alias Porte.2                                     ' RCLK
